...
void render()
{
    ...
    mRectangle.identity();
  	mRectangle.translate(0, 0, 0);
  	glLoadMatrixf(mRectangle.matrix);
    ...
    // Construct the matrix to apply to the second red rectangle
    mRectangle.identity();
  	mRectangle.translate(0.3f, 0, 0);
  	glLoadMatrixf(mRectangle.matrix);

    // draws a square but using the Matrix transformed above
