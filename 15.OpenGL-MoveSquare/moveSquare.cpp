...
//	----------------------------------------------------------
//	A C++ SDL Application
//	Drawing and Moving a square using SDL Keyboard and Matrix transform
//  ----------------------------------------------------------
//  How to compile:
...
// OpenGL Utilities
#include "OGLUtil.h"    // all OpenGL headers (no more use of glut)
#include "Matrix4x4.h"  // Matrix Maths Functions

/****************************** PROTOTYPES ******************************/
// we now separates our procedures into chunks for easy management
void checkKeyPress();
void initOpenGL();
...
int main(int argc, char**argv)
{
    ...
    while (isRunning) {
        checkKeyPress();  // handles keypress is now chunked in a method
